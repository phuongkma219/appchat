...
public interface ApiInterface {
    ...
    @POST("/users/info")
    Call<ApiResponse<UserInfo>> updateUserInfo(@Body UserInfo info);
    ...
    @POST("/users/add")
    Call<ApiResponse<AuthenResponse>> registNewAccount(@Body UserRegistRequest regist);
    ...
    Call<ApiResponse<String>> removeConversation(@Path("id") String id);
