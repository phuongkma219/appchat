...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        dashboardViewModel.getSuggest().observe(getViewLifecycleOwner(),userInfos -> {
            suggestView.upDateList(userInfos);
        });

        dashboardViewModel.getFeeds().observe( getViewLifecycleOwner() , feeds -> {
            dashboardAdapter.setFeeds(feeds);
        });
