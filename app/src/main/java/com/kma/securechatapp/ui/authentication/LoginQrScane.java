...
public class LoginQrScane extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(LoginQrScane.this, RealtimeService.class);
    ...
    void gotPrivateKey(String json) throws IOException {
        ...
        AppData.getInstance().account = message.getAccount();
        AppData.getInstance().userUUID = this.uuid;
        DataService.getInstance(this).storeToken(message.getToken(),message.getRefresh());
        DataService.getInstance(this).storeUserAccount(AppData.getInstance().account);
        DataService.getInstance(this).storeUserUuid(this.uuid);
        DataService.getInstance(this).storePrivateKey(this.uuid,  userKey.privateKey  ,null);
